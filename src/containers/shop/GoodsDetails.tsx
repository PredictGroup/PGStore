...
import {ShopParamList, ShopGoodsDetailsScreenRouteProp} from '../../../types';
...
interface Props {
  route: ShopGoodsDetailsScreenRouteProp;
  navigation: StackNavigationProp<ShopParamList, 'GoodsDetailsScreen'>;
}
...
const GoodsDetailsScreen: React.FC<Props> = ({route, navigation}) => {
  ...
  const _goodsDetails = useAppSelector(GoodsDetails);
  const [goodsDetails, setGoodsDetails] = React.useState(_goodsDetails);
  ...
  React.useEffect(() => {
    //console.log('GoodsDetailsScreen shop: ', _goodsDetails);
    setGoodsDetails(_goodsDetails);
  }, [_goodsDetails]);
